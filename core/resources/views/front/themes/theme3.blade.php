    ...
    @if ($extra_settings->is_t3_slider == 1)
        <div  class="hero-area3" >
            ...
            <div class="heroarea-slider owl-carousel">
                ...
                <div class="item" style="height:500px;  background: url('{{ asset('assets/images/' . $slider->photo) }}')">
                    <div class="container">
                    <div class="row">
                        ...
                        <div class="col-lg-3 col-sm-6 text-center mb-30">
                            <div class="single-service single-service2">
                                ...
                                <div class="content">
                                    ...
                                    <p class="text-sm text-muted mb-0" style="margin: 0 2 20px;">{{ $service->details }}</p>
                                </div>
                            </div>
                        </div>
                    @endforeach
 ...
 <div class="bannner-section mt-50">
            <div class="container ">
                <div class="row gx-3">
                    ...
                    <div class="col-md-6">
                       <img loading="lazy" decoding="async" width="494" height="575" src="https://eksali.com/assets/images/alt-services-pic1.jpg" class="attachment-full size-full" alt="" srcset="https://eksali.com/assets/images/alt-services-pic1.jpg 494w, https://eksali.com/assets/images/alt-services-pic1-258x300.jpg 258w" sizes="auto, (max-width: 494px) 100vw, 494px">
                    </div>
                   ...
                   <div class="single-service">
                        <h3> <b>Take Your Business Beyond Limits</b></h3>
                        
                <br>We are a Website Design and Development Company passionate about crafting exceptional website designs, innovative development solutions, and impactful digital marketing strategies. Our mission is to create unique and professional online branding for businesses by blending creativity with cutting-edge technologies.</p>
                <p><strong>Our Services</strong></p>
                <ul>
                <li><strong>Website Design and Development</strong>: Offering comprehensive solutions tailored to meet the needs of modern businesses.</li>
                <li><strong>Digital Marketing</strong>: Elevating your online presence and driving growth through data-driven strategies.</li>
                <li><strong>Application Development</strong>: Building user-friendly and efficient apps for various platforms.</li>
                <li><strong>Business Support Software Development</strong>: Providing custom software solutions to optimize your operations.</li>
                </ul>
