...
<header class="site-header navbar-sticky">
    <div class="menu-top-area">
        <div class="container">
            <div class="row">
                <div class="col-md-4">
                 <!--  <a class="track-order-link" href="#"> Tech Innovation & Marketing </a>-->
				<!--
                    <div class="t-m-s-a">
                ...
                <div class="col-md-8">
                    ...
                    <a class="track-order-link" href="#"><i class="icon-phone-call"></i>Call Us : +91-9399559527, +91-7313131626</a>
            ...
            <div class="row">
                <div class="col-lg-12">
                    <div class="d-flex justify-content-between">
                        <!-- Logo-->
                        <div class="site-branding hidden-on-mobile"><a class="site-logo align-self-center" style=" width: 208px;" href="{{route('front.index')}}"><img src="{{asset('assets/images/'.$setting->logo)}}" alt="{{$setting->title}}"></a></div>
                        
                         <div class="mobile-only" style="" ><a class="site-logo align-self-center" style=" width: 100px;" href="{{route('front.index')}}"><img src="{{asset('assets/images/'.$setting->logo)}}" alt="{{$setting->title}}"></a></div>
                        <!--visible-on-mobile , hidden-on-mobile,  Search / Categories-->
            ...
            <div class="row g-3 w-100">
               <!-- <div class="col-lg-3">
                ...
                <div class="col-lg-9 d-flex justify-content-between">
                    <div class="nav-inner"  style="margin-left: auto;" >
                        <nav class="site-menu">
                            <ul>
                                ...
                                <li class="t-h-dropdown">
                                    <a class="main-link" href="#">{{__('Others')}} <i class="icon-chevron-down"></i></a>
                                    <div class="t-h-dropdown-menu">
                                        @if ($setting->is_faq == 1)
                                ...
                                <div class="tab-pane fade show active" id="mmenu" role="tabpanel" aria-labelledby="mmenu-tab">
                                    <nav class="slideable-menu">
                                        <ul>
                                            ...
                                            @endif
                                            <li class="t-h-dropdown">
                                                <a class="" href="#"><i class="icon-chevron-right"></i>{{__('Others')}} <i class="icon-chevron-down"></i></a>
                                                <div class="t-h-dropdown-menu">
                                                    @if ($setting->is_faq == 1)
                                                    <a class="{{ request()->routeIs('front.faq*') ? 'active' : '' }}" href="{{route('front.faq')}}"><i class="icon-chevron-right pr-2"></i>{{__('Faq')}}</a>
                                                    @endif
